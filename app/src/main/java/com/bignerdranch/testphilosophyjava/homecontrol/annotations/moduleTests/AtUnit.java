...
import com.bignerdranch.testphilosophyjava.homecontrol.io.BinaryFile;
import com.bignerdranch.testphilosophyjava.homecontrol.io.ProcessFiles;
...
public class AtUnit implements ProcessFiles.Strategy {
    ...
    static List<String> failedTest = new ArrayList<String>();
    ...
    public void process(File cFile){
        ...
        for (Method m: testMethods){
            ...
            try {
                ...
                if (!success){
                    failures++;
                    failedTest.add(testClass.getName()+
                            ": "+m.getName());
                }
                if (cleanup != null)
